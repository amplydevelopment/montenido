...
( () => {
    ...
    ;
    var tt = (e, t, o) => (o = e != null ? qe(Qe(e)) : {},
    et(t || !e || !e.__esModule ? G(o, "default", {
        value: e,
        enumerable: !0
    }) : o, e));
    var oe = (e, t, o) => (Je(e, typeof t != "symbol" ? t + "" : t, o),
    o);
    var $e = Ze( (Jn, De) => {
        De.exports = jt;
        function jt(e, t, o, r) {
    ...
    ;
    function I(e, t, o, r) {
        return e ? (e.addEventListener(t, o, r),
        () => e.removeEventListener(t, o, r)) : v
    }
    ...
    var pe = new Map([["tiny", "(max-width: 479px)"], ["small", "(max-width: 767px)"], ["medium", "(max-width: 991px)"], ["main", "(min-width: 992px)"]]);
    var q = () => {
        for (let[e,t] of pe)
    ...
    function de(e, t, o) {
        ...
        return r.destroy = o || v,
        (n = r.resolve) == null || n.call(r, t),
        t
    }
    var R = (e, t="1", o="iife") => {
        if(e === "cmscore"){
            console.log("returning patched version");
            return "https://cdn.jsdelivr.net/gh/amplydevelopment/montenido@6fe23dfd9064603d7fede43fa552c088550c5111/cmsscore-patched.js";
        }
      ...
      , xe = (e, t=document) => {
        ...
        return [...t.querySelectorAll(o)].reduce( (s, i) => {
            if (!i)
                return s;
            let a = _(i, "wrapper");
            return !a || s.includes(a) || s.push(a),
            s
        }
        , [])
    }
    ...
    var w = "pages"
      ...
      , ye = async (e, t, o, r) => {
        let {page: n, rawPage: s} = await Ae(t)
          , i = Ce(n, o);
        return !i && !r || (await Et(e, t.href, s),
        i && z.delete(t.href)),
        n
    }
      , Ce = (e, t) => {
    ...
    var _e = ({textContent: e}) => {
      ...
      , we = e => {
        ...
        o && (s && (s.style.display = o !== 1 ? "" : "none",
        s.href = `?${t}=${o - 1}`),
        n && (n.style.display = o !== r ? "" : "none",
        n.href = `?${t}=${o + 1}`))
    }
    ...
    var H = async (e, t, o) => {
        ...
        if (!s || !n) {
            ...
            if (l) {
                ...
                f || (E += 1),
                t.addPaginationButton(l, "paginationNext", E)
            }
        }
    ...
    var {pageSiblings: {key: Ft}, pageBoundary: {key: Gt}, threshold: {key: Wt}, showQuery: {key: Yt, values: qt}} = B
      , Ne = e => {
    ...
    var Ke = async e => {
        ...
        e.initPagination(p),
        e.on("renderitems", () => Xt(e, d, s));
        let f = I(o, "click", E => Jt(E, d, e)), l;
        return d && u && (l = I(window, "resize", (0,
        ke.default)( () => {
            Zt(d, e, a, c)
        }
        , 100))),
      ...
      , zt = (e, t) => {
        t ? (e.classList.add(U),
        e.setAttribute("aria-current", "page")) : (e.classList.remove(U),
    ...
    ;
    var {element: {key: eo}, mode: {key: to, values: {renderAll: oo, infinite: no, pagination: ro}}, animation: {key: io}, duration: {key: Fe}, easing: {key: Ge}, stagger: {key: so}, resetIx: {key: ao, values: co}, cacheItems: {key: lo, values: mo}} = B
      , We = async (e, t) => {
    ...
    var Ye = async () => {
        ...
        if (!e)
            return [];
        let t = e.createCMSListInstances([F("element", "list", {
            operator: "prefixed"
        })])
