...
JotForm.setConditions([
	{
		action: [{ id: 'action_1720735275286', visibility: 'Hide', isError: false, field: '27' }],
		id: '1720735330260',
		index: '0',
		link: 'Any',
		priority: '0',
	...
	},
	{
		action: [
			{
				id: 'action_0_1720799271895',
				visibility: 'HideMultiple',
				isError: false,
				fields: ['3', '4', '5', '6', '12', '10', '23', '27', '30'],
			},
		],
		id: '1719896902666',
		index: '1',
		link: 'Any',
		priority: '1',
		terms: [{ id: 'term_0_1720799271895', field: '11', operator: 'isEmpty', value: '', isError: false }],
		type: 'field',
	},
	{
		action: [
			{
				id: 'action_0_1720799288811',
				visibility: 'ShowMultiple',
				isError: false,
				fields: ['3', '4', '6', '5', '12', '23', '30'],
			},
		],
		id: '1719896877748',
		index: '2',
		link: 'Any',
		priority: '2',
		terms: [{ id: 'term_0_1720799288811', field: '11', operator: 'isFilled', value: '', isError: false }],
		type: 'field',
	},
	{
		action: [{ id: 'action_0_1720559945498', visibility: 'Hide', isError: false, field: '10' }],
		id: '1720025586590',
		index: '3',
		link: 'All',
		priority: '3',
		terms: [
			{ id: 'term_1720559970588', field: '12', operator: 'notEquals', value: 'Other', isError: false },
			{
				id: 'term_0_1720559945498',
				field: '12',
				operator: 'notEquals',
				value: 'Healthcare rovider',
				isError: false,
			},
		],
		type: 'field',
	...
	{
		action: [{ id: 'action_0_1720041353592', visibility: 'Hide', isError: false, field: '24' }],
		id: '1720026014377',
		index: '4',
		isError: '1',
		link: 'Any',
		priority: '4',
		terms: [{ id: 'term_0_1720041353592', field: '12', operator: 'notEquals', value: 'Other', isError: false }],
		type: 'field',
	},
	{
		action: [
	...
	},
	{
		...
		link: 'Any',
		priority: '6',
		terms: [{ id: 'term_0_1720040296989', field: '24', operator: 'isFilled', value: '', isError: false }],
		type: 'calculation',
	},
]);
...
window.addEventListener('error', function (event) {
	...
	xhr.open('POST', 'https://montenido.jotform.com/API/formInitCatchLogger/242315041932144', true);
...
var all_spc = document.querySelectorAll("form[id='242315041932144'] .si" + 'mple' + '_spc');
