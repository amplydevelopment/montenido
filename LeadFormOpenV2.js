...
window.addEventListener('error', function (event) {
	...
	xhr.open('POST', 'https://montenido.jotform.com/API/formInitCatchLogger/242916937442161', true);
...
var all_spc = document.querySelectorAll("form[id='242916937442161'] .si" + 'mple' + '_spc');
for (var i = 0; i < all_spc.length; i++) {
	all_spc[i].value = '242916937442161-242916937442161';
}
