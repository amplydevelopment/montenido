...
if (form) {
	form.addEventListener('submit', function (event) {
		...
		// 1. Capture and truncate the URL right before submission
		var currentUrl = window.location.href;
		if (currentUrl.length > 255) {
			currentUrl = currentUrl.substring(0, 255);
		}
		var urlInput = document.getElementById('input_21');
		if (urlInput) {
			urlInput.value = currentUrl;
		}

		// 2. Capture form data for GTM
		var firstName = document.getElementById('input_3') ? document.getElementById('input_3').value : '';
		var lastName = document.getElementById('input_4') ? document.getElementById('input_4').value : '';
		var email = document.getElementById('input_5') ? document.getElementById('input_5').value : '';
		var phone = document.getElementById('input_6_full') ? document.getElementById('input_6_full').value : '';
		var zip = document.getElementById('input_30') ? document.getElementById('input_30').value : '';
		var ManualSource = document.getElementById('input_12') ? document.getElementById('input_12').value : '';

		// 3. Push data to the GTM data layer
		dataLayer.push({
